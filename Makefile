...
.PHONY: e2e
e2e:
	./test/e2e/run_test.sh -run "TestKmeshRestart\|TestCrossNamespace" --skip-cleanup-apps

.PHONY: e2e-ipv6
e2e-ipv6:
	./test/e2e/run_test.sh -run "TestKmeshRestart\|TestCrossNamespace" --ipv6 --skip-cleanup-apps
